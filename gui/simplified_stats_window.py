# gui/simplified_stats_window.py - Версия БЕЗ временного анализа
...
class SimplifiedStatsWindow:
    ...
    def create_interface(self):
        ...
        # ✅ ИЗМЕНЕНИЕ: Убираем Notebook и создаем только один фрейм для распределений
        features_frame = ttk.LabelFrame(self.window, text="Распределения признаков", padding=15)
        ...
        self.canvas_features = FigureCanvasTkAgg(self.fig_features, features_frame)
